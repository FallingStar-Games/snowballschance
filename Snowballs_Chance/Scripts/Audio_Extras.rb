...
module AudioExtras
    ...
    class Game_System
      ...
      def initialize
        ...
        @saved_bgm_vol = nil
        @saved_bgs_vol = nil
        #right after the splash screens
      end
      #==========================================================================
      ...
      #--------------------------------------------------------------------------
      def bgm_play(bgm)
        #whenever the bgm is specified
        if @bgm_master_vol == nil then @bgm_master_vol = 100 end
          
        @playing_bgm = bgm
        if bgm != nil and bgm.name != "" # it crashes here
      ...
      #--------------------------------------------------------------------------
      def bgs_play(bgs)
        if @bgs_master_vol == nil then @bgs_master_vol = 100 end
      ...
      #--------------------------------------------------------------------------
      def me_play(me)
        if @me_master_vol == nil then @me_master_vol = 100 end
      ...
      #--------------------------------------------------------------------------
      def se_play(se)
        if @se_master_vol == nil then @se_master_vol = 100 end
