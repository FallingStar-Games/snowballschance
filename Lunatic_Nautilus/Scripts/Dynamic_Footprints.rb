...
class Spriteset_Map
 ...
 def initialize
   @viewport1 = Viewport.new(0, 0, 640, 480)#screen stuff
   @viewport2 = Viewport.new(0, 0, 640, 480)#pictures
   @viewport3 = Viewport.new(0, 0, 640, 480)#flashing
   @viewport2.z = 200
   @viewport3.z = 5000
